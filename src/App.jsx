...
export default function App() {
  return (
    ...
    <div className="mt-20 flex flex-col items-center">
      ...
      <button className="mt-2 text-base bg-red-500 hover:bg-red-400 text-white p-2 rounded-lg drop-shadow-lg" onClick={() => (window.location.href = "https://forms.gle/quydRSdrdnKSW5YS6")}>Submit Paper (Term End)</button>
        </div>
      <div className="mt-20 flex flex-col items-center">
        <>
...
<span className="rounded-lg bg-white p-2 bg-opacity-40 items-center">Made with ❤️ by <a href="https://github.com/aditya9277" className="text-white font-semibold">Aditya</a> and <a href="https://github.com/abkux" className="text-white font-semibold">Abhishek</a>!</span>
</div>
</div>
    </>
  );
