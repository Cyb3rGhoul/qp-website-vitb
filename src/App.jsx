  ...
  return (
    <>
      ...
      <div className="mt-20 flex flex-col items-center">
        ...
        <span className="mt-10 text-sm text-gray-400">⚠️Note: You can submit question paper by using below link!</span>
        <p className="text-sm text-gray-400">🔍 Press <span className="font-bold text-white">(Ctrl + F)</span> and enter the subject code you looking.</p>
